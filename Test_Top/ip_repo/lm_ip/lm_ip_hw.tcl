...
set_module_property NAME lm_ip
set_module_property VERSION 1.0
set_module_property DISPLAY_NAME "LM"
set_module_property GROUP "Custom IP"
set_module_property TOP_LEVEL_HDL_ENTITY Lm_Ip
set_module_property HDL_FILES [list "lm_ip.vhd" "../common/inoutput_types.vhd"]
