...
set_module_property NAME difi_ip
set_module_property VERSION 1.0
set_module_property DISPLAY_NAME "DIFI"
set_module_property GROUP "Custom IP"
set_module_property TOP_LEVEL_HDL_ENTITY Difi_Ip
set_module_property HDL_FILES [list "difi_ip.vhd" "../common/inoutput_types.vhd"]
